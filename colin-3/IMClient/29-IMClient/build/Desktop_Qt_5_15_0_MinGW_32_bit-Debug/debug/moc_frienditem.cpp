...
QT_MOC_LITERAL(1, 11, 20), // "signals_sendMsgAndId"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 20), // "on_pb_friimg_clicked"
QT_MOC_LITERAL(4, 54, 18) // "slots_sendMsgAndId"

    },
    "FriendItem\0signals_sendMsgAndId\0\0"
    "on_pb_friimg_clicked\0slots_sendMsgAndId"
};
...
void FriendItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signals_sendMsgAndId((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->on_pb_friimg_clicked(); break;
        case 2: _t->slots_sendMsgAndId((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FriendItem::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FriendItem::signals_sendMsgAndId)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FriendItem::signals_sendMsgAndId(int _t1, QString _t2)
{
