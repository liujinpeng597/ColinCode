...
QT_MOC_LITERAL(1, 11, 15), // "signals_sendMsg"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13), // "slots_sendMsg"
QT_MOC_LITERAL(4, 42, 14) // "slots_clearMsg"

    },
    "ChatWidget\0signals_sendMsg\0\0slots_sendMsg\0"
    "slots_clearMsg"
};
...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signals_sendMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatWidget::signals_sendMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatWidget::signals_sendMsg(QString _t1)
{
